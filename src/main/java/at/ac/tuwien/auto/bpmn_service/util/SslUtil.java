...
public class SslUtil {
    public static SSLSocketFactory getSocketFactory (final Path caCrtFile, final Path crtFile, final Path keyFile,
        ...
        bis = new BufferedInputStream(new FileInputStream(crtFile.toFile()));
        ...
        PEMParser pemParser = new PEMParser(new FileReader(keyFile.toFile()));
